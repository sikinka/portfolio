...
(function (l) {
  ...
  u.defaults = {
    ...
    oLanguage: {
      ...
      sEmptyTable: "No Anime available in table",
      sInfo: "Showing _START_ to _END_ of _TOTAL_ Anime",
      sInfoEmpty: "Showing 0 to 0 of 0 Anime",
      sInfoFiltered: "(filtered from _MAX_ total Anime)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "Show _MENU_ Anime",
